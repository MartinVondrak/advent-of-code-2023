...
class CubeGambleTest {
    ...
    fun `Task 2_1 example data should produce 8`() {
        val result = CubeGamble("src/test/resources/day2/input.txt").calculateSumOfValidGames()
        assertEquals(8, result)
    }

    @Test
    fun `Task 2_2 example data should produce 2286`() {
        val result = CubeGamble("src/test/resources/day2/input.txt").calculateSumOfPowerOfGames()
